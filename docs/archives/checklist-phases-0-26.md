# Plugin WordPress - Archive checklist (Phases 0–26)

**Archivé le :** 2026-05-01
**Source :** ancien `docs/checklist.md` (phases terminées)
**But :** historique complet des phases livrées. Pour le travail actif, voir `docs/checklist.md`.
...
> Validation manuelle pending : voir `checklist.md` § "Validation manuelle pending".
...
> Validation manuelle pending (FAQ post client) + cleanup post 63657 : voir `checklist.md` § "Validation manuelle pending".
...
> Validation manuelle pending (docker dev local) : voir `checklist.md` § "Validation manuelle pending".
